...
set CLASSPATH=%APP_HOME%\lib\http-test-0.0.1-SNAPSHOT.jar;%APP_HOME%\lib\json-20190722.jar;%APP_HOME%\lib\http-tiny-server-1.0.jar


@rem Execute http-test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HTTP_TEST_OPTS%  -classpath "%CLASSPATH%" rest.cli.CLI %*
