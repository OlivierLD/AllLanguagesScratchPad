 ...
 * Adapted to ES6 by OlivierLD
 */
 // Encapsulate variables and functions to allow instanciation of multiple dialog boxes

function DialogBox(id, callback) { // This is like an Object. TODO Move to ES 6, with a constructor instead of _init?
		
	let	_minW = 100, // The exact value will get calculated
		_minH = 1, // The exact value will get calculated
		_resizePixel = 5,
	...
	*/
	...
	_onMouseDown = (evt) => {
		...
		let r = _dialog.getBoundingClientRect();
		return _returnEvent(evt);
	},
