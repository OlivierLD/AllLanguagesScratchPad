...
#
# pushd is used below. It's more powerful than cd, in the sense
# that it can be stacked.
# pushd A, pushd B
# then popd, popd will bring you back where you started from (before pushd A).
#
